...
<!-- Delete Confirmation Modal (Moved to root level conceptually via fixed positioning) -->
...
<style>
    /* SOBRESCREVE estilos locais problemáticos */
    ...
    /* 0. Container Overflow Protection */
    .container {
        max-width: 100%;
        overflow-x: hidden;
    }
    ...
    .table-container {
        ...
        margin: 0 -1rem;
        /* Negative margin on mobile to utilize full width */
        padding: 0 1rem;
    }
    ...
    /* Modal Styles - Global & Theme Aware */
    #delete-modal {
    ...
    /* --- MOBILE FIRST OPTIMIZATIONS (USING GLOBAL DESIGN SYSTEM) --- */
    ...
    /* 2. Responsive Header uses .flex-col-mobile global utility now */
    ...
    /* 4. Stat Cards Typography - Mobile Adjustment */
    ...
    #delete-modal .modal-overlay {
        ...
        inset: 0;
        background-color: transparent !important;
        /* User requested NO background color */
    ...
    /* Modal Card - Theme Variables from design-system.css */
...
<script>
    ...
    function openDeleteModal(message, callback) {
        ...
        // Ensure display is flex (overriding inline style if needed)
