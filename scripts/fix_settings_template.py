...
<div class="container">
    ...
    <div class="grid-responsive-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p style="font-size: 13px; color: #6b7280; margin-bottom: 16px;">Defina o logo, nome e cores da sua agencia.</p>
                <div class="flex items-center gap-3">
                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-100">
                        {% if agency.logo_light %}
                            <img src="{{ agency.logo_light.url }}" alt="Logo" style="height: 32px; object-fit: contain;">
                        {% else %}
                            <div style="height: 32px; width: 32px; background: var(--primary-color); border-radius: 4px; display: flex; align-items: center; justify-content: center; color: white;">P</div>
                        {% endif %}
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p style="font-size: 13px; color: #6b7280; margin-bottom: 16px;">Usados quando o projeto nao especifica
                    modelo proprio.</p>
                <form method="post">
                    {% csrf_token %}
                    ...
                    <div class="form-group">
                        ...
                        <span class="form-help" style="font-size: 12px; color: #6b7280;">Pollinations = gratuito/barato.
                            OpenAI = premium.</span>
                    </div>
                    <button type="submit" class="btn btn-primary">Salvar</button>
                </form>
