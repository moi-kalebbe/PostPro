...
# -*- coding: utf-8 -*-
"""
Script to fix the corrupted public_v2.html template.
This rewrites the entire file with correct Django template syntax.
"""
    ...
    <section id="contato" class="contact-section">
        <div class="container">
            ...
            <form id="lead-form" class="contact-form">
                ...
                <div class="form-group">
                    <label for="company_name">Site/Empresa</label>
                    <input type="text" id="company_name" name="company_name" placeholder="www.seusite.com.br">
                </div>
                {% if plans %}
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="message" rows="3" placeholder="Conte mais sobre seu projeto..."></textarea>
                </div>
        ...
        document.getElementById('lead-form').addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    this.reset();
                    setTimeout(() => { document.getElementById('success-modal').classList.remove('show'); }, 4000);
                } else { alert('Erro: ' + result.error); }
            } catch (error) { alert('Erro ao enviar. Tente novamente.'); console.error(error); } finally { btn.disabled = false; btn.textContent = 'Enviar'; }
        });
...
template_path = os.path.join(project_root, 'templates', 'landing_page', 'public_v2.html')
...
print("The following issues were corrected:")
print("  1. Fixed broken CSS variables with Django template syntax (lines 17-35)")
print("  2. Fixed broken {% endif %} tag on line 771")
print("  3. Ensured proper UTF-8 encoding")
print("  4. Cleaned up all Django template tags to be on single lines")
