"""
Django settings for PostPro project.
Multi-tenant SaaS for WordPress content automation with AI.
"""
...
ALLOWED_HOSTS = env('ALLOWED_HOSTS') + ['.vercel.app', '.now.sh']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.agency_branding',
            ],
        },
    },
]
